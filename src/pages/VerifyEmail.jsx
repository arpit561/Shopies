...
function VerifyEmail() {
  ...
  const handleVerifyAndSignup = (e) => {
    e.preventDefault();
    // if (!signupData) {
    //   console.warn("signupData is missing");
    //   return;
    // }  
    const { name, phone, email, password, confirmPassword, role } = signupData;

    dispatch(signUp(name, phone, email, password, confirmPassword, role, otp, navigate));
    console.log("Otp: ", otp);
  };
